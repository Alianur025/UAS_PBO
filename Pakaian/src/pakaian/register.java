...
public class register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(195, 174, 214));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (Connection conn = koneksi.conn.BukaKoneksi(); 
             PreparedStatement pstmt = conn.prepareStatement("INSERT INTO user (nama, password, role) VALUES (?, ?, 'pembeli')")) {
